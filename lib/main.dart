...
// 1. Importaciones obligatorias para sqflite en Web
import 'package:sqflite_common_ffi_web/sqflite_ffi_web.dart';
import 'package:sqflite/sqflite.dart';

void main() async {
  // 2. Primero el binding de Flutter
  WidgetsFlutterBinding.ensureInitialized();
  
  // 3. SEGUNDO: Configurar el factory web ANTES de cualquier operación de base de datos
  if (kIsWeb) {
